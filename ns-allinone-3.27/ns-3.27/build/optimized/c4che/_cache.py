...
CC = ['/usr/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Werror', '-std=c++11', '-march=native', '-fstrict-overflow', '-Wstrict-overflow=2', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-std=c++11', '-march=native', '-fstrict-overflow', '-Wstrict-overflow=2', '-std=c++11']
...
EXAMPLE_DIRECTORIES = ['realtime', 'energy', 'stats', 'wireless', 'socket', 'tutorial', 'udp-client-server', 'udp', 'matrix-topology', 'naming', 'tcp', 'ipv6', 'routing', 'traffic-control', 'error-model']
EXEC_PREFIX = '/usr/local'
HAVE_MPI = 1
HTMLDIR = '/usr/local/share/doc/ns'
INCLUDEDIR = '/usr/local/include'
INCLUDES_MPI = ['/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent', '/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include', '/usr/lib/openmpi/include', '/usr/lib/openmpi/include/openmpi']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_MPI = ['/usr/lib/openmpi/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_MPI = ['mpi_cxx', 'mpi']
LIB_RT = ['rt']
...
LINKFLAGS_MPI = ['-pthread', '-Wl,--enable-new-dtags', '-Wl,-rpath,/usr/lib/openmpi/lib']
...
NS3_EXECUTABLE_PATH = ['/home/jake/Bitcoin-Simulator/ns-allinone-3.27/ns-3.27/build/optimized/src/fd-net-device', '/home/jake/Bitcoin-Simulator/ns-allinone-3.27/ns-3.27/build/optimized/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/jake/Bitcoin-Simulator/ns-allinone-3.27/ns-3.27/build/optimized']
...
cfg_files = ['/home/jake/Bitcoin-Simulator/ns-allinone-3.27/ns-3.27/build/optimized/ns3/config-store-config.h', '/home/jake/Bitcoin-Simulator/ns-allinone-3.27/ns-3.27/build/optimized/ns3/core-config.h']
cprogram_PATTERN = '%s'
