...
main (int argc, char *argv[])
{
  ...
  double latency = 40;
  bool test = false;
  // Use the selfish miner if true and the simple attacker if false
  bool selfish = true;
...
/*   double minersHash[] = {0.4, 0.4, 0.3};
  ...
  cmd.AddValue ("selfish", "Use the selfish miner if true and the simple attacker if false", selfish);
