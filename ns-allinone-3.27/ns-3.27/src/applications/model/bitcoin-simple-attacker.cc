...
BitcoinSimpleAttacker::StopApplication ()
{
  ...
  std::cout << "The simple attacker " << GetNode ()->GetId () << " with hash rate = " << m_hashRate << " generated " << m_minerGeneratedBlocks 
                ...
                << " and average size " << m_minerAverageBlockSize << " Bytes" << std::endl;
